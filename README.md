...
Nessa tela, preenchemos com o nome desejado para o repositório, em seguida, a descição. Depois disso, é necessário selecionar um das opções para deixar seu repositório publico ou privado. E por ultimo, temos a opçaõ de criar o repositório com um readme e com um gitignore.
...
Abrimos o git bash e digitamos os seguintes comandos para configura-lo na conta git do usuario:
...
Caso fizer alguma alteração, simplesmente utilizar os três códigos da imagem:
...
OBS: para posiciona-los, arrastar as bolinhas brancas até as extreminadades da tela, assim, o objeto fica fixo. Como nas fotos a seguir:
...
- ##### Exercício 1
 ...
 Nessa activity, o elemento diferenciado que foi utilizado, foi o LinearLayout, no qual alinha todos os filhos em uma única direção vertical.

 ![image](https://github.com/rebekaamorim/atividade_/assets/127450671/9ddab859-95b5-49a7-a06e-24ef19a3ce99)
...
#### *Adicionando nova activies para cada tela
...
- #### Código da tela do Exercício 1

Declaramos as variáveis

![image](https://github.com/rebekaamorim/atividade_/assets/127450671/bf866289-4b13-4015-850e-3094ac5df428)

Depois, vinculamos ela ao elemento da activity que irá ser manipulado, assim, adicionamos a funcionalidade ao botão

![image](https://github.com/rebekaamorim/atividade_/assets/127450671/054e9d94-65a5-4b94-845e-7ac97004871f)

Criando o método que vai verificar

![image](https://github.com/rebekaamorim/atividade_/assets/127450671/3deece5a-96df-407d-877d-deb9095af850)

![image](https://github.com/rebekaamorim/atividade_/assets/127450671/76981940-0167-4d2b-8546-90f2635328a5)

Obs.: Na formúla/condição, "if (a % b == 0 || b % a == 0)" vai verificar se o resto da divisão de "a" por "b" é igual a zero ou (||)
se o resto da divisão de "b" por "a" é igual a zero. Isso indica que um dos números é um múltiplo do outro.
